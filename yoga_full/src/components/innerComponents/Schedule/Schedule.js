...
const Schedule = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setData(fetchData);
            if (fetchData != null){
                setSelectedDay(fetchData[0].day);
            }
