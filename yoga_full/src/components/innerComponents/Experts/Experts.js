            ...
            <div className={styles.flex_row3}>
                {selectedExpert && (
                    <div className={styles.flex_col}>
                        ...
                        <div className={`${styles.flex_row4} ${isFadingOut ? styles.fadeOut : styles.fadeIn}`}>
                            ...
                            <div className={styles.content_box1}>
                                <div className={styles.flex_col4}>
                                    ...
                                    <p className={styles.text1}>{selectedExpert.desc}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <div className={styles.flex_row5}>
                                {selectedExpert.background_images.map((item, index) => (
                                    <div className={styles.flex_col6} key={index}>
